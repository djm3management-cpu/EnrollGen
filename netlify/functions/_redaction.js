const DEEPGRAM_REDACTION_GROUPS = ["pii", "phi", "pci"];
...
export function applyDeepgramRedactionParams(url) {
  for (const group of DEEPGRAM_REDACTION_GROUPS) {
    url.searchParams.append("redact", group);
  }
  return url;
}
...
export function redactDiarizedTranscript(entries = []) {
