/**
 * AcaCopilot.jsx — ACA Marketplace Co-Pilot UI
 * Wires useAcaCopilotEngine + useSpeechRecognition into a single panel.
 * Sits above ACAFlow in ACAScript.jsx.
...
const AcaCopilot = memo(function AcaCopilot() {
  ...
  return (
    <>
      {/* ── Floating Alert ── */}
      {floatingAlert && (() => {
        const s = ACA_LEVEL_STYLE[floatingAlert.level] || ACA_LEVEL_STYLE.info;
        ...
        const floatLabel = { critical: "CRITICAL ALERT", warn: "WARNING", tip: "TIP", remind: "REMINDER", info: "ACA CO-PILOT" }[floatingAlert.level] || "ACA CO-PILOT";
        return (
          <div
      ...
      <section className="card prompter-card">
        ...
        <div className="prompter-header" onClick={() => setExpanded((p) => !p)}>
          <div className="prompter-header-left">
            ...
            <div>
              <h2 style={{ margin: 0 }}>ACA CO-PILOT</h2>
