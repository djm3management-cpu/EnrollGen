/**
 * MedSupAiCopilot.jsx — Medicare Supplement AI Co-Pilot UI
 * Real-time speech compliance monitor for Med Sup enrollment calls.
...
const MedSupAiCopilot = memo(function MedSupAiCopilot() {
  ...
  const copilot = useMedSupCopilotEngine({ transcriptRef, activeSection, state });
  ...
  return (
    <>
      {/* ── Floating Alert ── */}
      {floatingAlert && (() => {
        const s = MEDSUP_LEVEL_STYLE[floatingAlert.level] || MEDSUP_LEVEL_STYLE.info;
        ...
        const floatLabel = { critical: "CRITICAL ALERT", warn: "WARNING", tip: "TIP", remind: "REMINDER", info: "MED SUP CO-PILOT" }[floatingAlert.level] || "MED SUP CO-PILOT";
        return (
          <div
      ...
      <section className="card prompter-card">
        ...
        <div className="prompter-header" onClick={() => setExpanded((p) => !p)}>
          <div className="prompter-header-left">
            ...
            <div>
              <h2 style={{ margin: 0 }}>MED SUP CO-PILOT</h2>
          ...
          <div className="prompter-body">
            ...
            <div style={{
              ...
              {[
                ...
                { label: "SECTION", value: `${activeSection} · ${currentStep.toUpperCase()}`, color: "#ffffff" },
            ...
            <div style={{
              ...
              <div style={{ flex: 1, display: "flex", gap: 4, minWidth: 180 }}>
                <input
                  ...
                  placeholder="Ask Med Sup Co-Pilot"
                  disabled={askLoading}
                  style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "40% 1fr", gap: 10, alignItems: "stretch", height: 220 }}>
              ...
              <div style={{
                ...
                <div ref={copilot.feedRef} className="panel-scroll" style={{ flex: 1, minHeight: 0, overflowY: "auto", display: "flex", flexDirection: "column", gap: 0 }}>
                  ...
                  {messages.map((msg) => {
                    const s = MEDSUP_LEVEL_STYLE[msg.level] || MEDSUP_LEVEL_STYLE.info;
                    return (
            ...
            {state.wrapOk && (
              <div style={{
                ...
                <div style={{ flex: 1, fontSize: 12, color: "#8fa4bc", lineHeight: 1.6 }}>
                  <div><strong style={{ color: "#dfe6f0" }}>Sections completed:</strong> {complianceScore.completed}/{complianceScore.totalSections}</div>
